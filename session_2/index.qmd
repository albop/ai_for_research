...
![Neural Network](assets/neural_networks.png)
...
![](assets/transformers.png){width=80%}
...
[ChatGPT](https://openai.com/blog/chatgpt) is an interface on top of GPT3.5 (now GPT4)
...
- chatgpt uses a version of gpt that is *fine-tuned* by interacting with [humans](https://time.com/6247678/openai-chatgpt-kenya-workers/)
